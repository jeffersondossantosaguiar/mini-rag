...
Decisões de arquitetura e seus trade-offs serão documentadas aqui conforme o projeto avança (ex: por que SQLx e não SeaORM, por que embeddings locais e não via API, IVFFlat vs HNSW, etc.)
